...
// Numbering: retail BFME2/ROTWK DeathType index table, indices 0-23
// (bfme2-workbench/research/spec-aod-crush.md §2.3; corroborated by
// research/ghidra-lane-r14.md Q-D7). CRC/persist-visible by design — must match
// the retail binary. Indices 0-12 coincide with the Generals numbering; above 12
// the two orders diverge. Names not in the retail table are packed contiguously
// above the retail range (24+) for legacy INI/save parsing.
public enum DeathType
{
    // --- Retail BFME2 table, 0-23 (spec-aod-crush.md §2.3) ---
