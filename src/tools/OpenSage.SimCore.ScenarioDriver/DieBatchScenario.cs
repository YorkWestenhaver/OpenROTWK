...
";
    ...
    private static readonly (string Definition, bool Neutral, float X, float Y)[] Spawns =
    {
        ...
        // crushing, so 8 (at +30) is nearest its BACK point and 9 (at -30) its FRONT point:
        // one spawn per crush-point branch, resolved by geometry rather than by a flag.
        ("DieBatchCrushVictim", false,  30f,   0f),  // 8 - CrushDie: back-end crush by 1
        ("DieBatchCrushVictim", false, -30f,   0f),  // 9 - CrushDie: front-end crush by 1
    };
